  ...
  //add a fieldset per parameter so people can add all of these
      ...
      addUser(first_name, last_name, email) {
        // Adds a new User
          ...
          //returning is maybe needed for the JSON blob 
          //would work without returning in terms of insertion into database 
          return db.one('INSERT INTO users (name,email) values (\$1,\$2) RETURNING name, email', ['dannielle', 'dfs@gmail.com']);
            // Adds a new Event
      }
